---
title: "Generative AI for Synthetic Data Across Multiple Medical Modalities: A Systematic Review"
slug: "generative-ai-synthetic-medical-data-review"
summary: >-
  This systematic review covers generative models (GANs, VAEs, diffusion
  models, and LLMs) used to synthesize medical data, spanning imaging
  (dermoscopic, mammographic, ultrasound, CT, MRI, X-ray), text,
  time-series, and tabular EHR data. Unlike prior narrowly focused reviews,
  it encompasses a broad array of modalities, offering insight into current
  and future applications across synthesis, generation techniques, and
  evaluation methods, alongside a GitHub repository as a living resource.
  The multi-modality scope surfaces cross-modality insights unavailable in
  single-modality surveys; core generative techniques are transferable, but
  synthesis methods often lack sufficient integration of patient-specific
  context and clinical knowledge. Findings are structured around three
  themes, synthesis applications, generation techniques, and evaluation
  methods, revealing an absence of standardized benchmarks and a need for
  large-scale, privacy-aware validation and cross-team benchmarking.
year: 2025
status: "completed"
tags:
  - generative-ai
  - synthetic-data
  - medical-imaging
paperUrl: "https://doi.org/10.1016/j.compbiomed.2025.109834"
draft: false
---
